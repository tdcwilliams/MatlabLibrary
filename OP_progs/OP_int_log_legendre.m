function Y = OP_int_log_legendre(xx,sing,An)
%% CALL: Y = OP_int_log_legendre(xx,sing,An)
%% xx\in[-1,1]
%% does integral \int_{-1}^1[ log|xx-sing|.\sum_{n=0}^Ngl[A_n.P_n(xx)] ]ds
